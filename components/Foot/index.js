  ...
  return (
    <div id="foot" className="mt-10 mb-60 mx-10" data-aos="fade-up" data-aos-duration="3000">
      ...
      <div className="p-5 md:w-3/4 md:m-auto">
        <p className="text-slate-500 text-center text-lg">I&apos;m currently looking for any new opportunities, my inbox is always open. Whatever you have a question or just to </p>
        <p className="text-slate-500 text-center text-lg">say hi, i&apos;ll try my best to get back to you</p>
      </div>

  ...
  return (
    <main>
      <div className="inside xl:p-24 max-[765px]:p-1 md:p-1">
        <div
          id="first-pages"
          className="mx-20 my-11 max-[765px]:mx-10"
          data-aos="fade-up"
        >
          <p className="p-color-style text-lg font-semibold">Hi, i&apos;am</p>
          <div className="py-5">
            <p className="text-slate-300 text-7xl font-semibold max-[765px]:text-3xl">
              Ari Rachaman.
            </p>
            <p className="text-slate-400 text-7xl font-semibold max-[765px]:text-5xl">
              I build things for the web.
            </p>
          </div>
          <div className="py-5">
            <p className="text-slate-500 text-lg  max-[765px]:text-base">
              im a frontend developer, passionate about learning and
              collaboration, i&apos;m
            </p>
            <p className="text-slate-500 text-lg  max-[765px]:text-base">
              currently looking for any new opportunities.
            </p>
          </div>
        </div>
        ...
        <div
          id="about-me"
          className="mx-20 mt-60 mb-40 max-[765px]:mx-10"
          data-aos="fade-up"
        >
          <div className="flex max-[765px]:block">
            <div className="mr-20 max-[765px]:mr-0">
              <div className="mb-5">
                <p className="text-slate-300 text-3xl font-bold my-10 max-[765px]:text-2xl">
                  <span className="text-2xl p-color-style max-[765px]:text-xl">
                    01.
                  </span>{" "}
                  About Me
                </p>
                <div className="border-orange-200 border-2 rounded-xl border-dashed h-fit min-[765px]:hidden min-[765px]:w-fit">
                  <Image
                    ...
                    height={1600}
                    alt="profile"
                    className="rounded-xl mt-5 ml-5 grayscale hover:grayscale-0 min-[765px]:mt-0 min-[765px]:ml-5"
                  />
                </div>
                <p className="text-slate-400 text-justify text-lg max-[765px]:text-base pt-5">
                  Hi, My name is{" "}
                  <span className="p-color-style">Ari Rachman</span> but I want
                  you to call me <span className="p-color-style">Ari</span>, I
                  am a frontend developer who loves to create beautiful and
                  functional websites. I am an informatics student at the Telkom
                  Purwokerto Institute of Technology (ITTP) who loves to learn
                  and has a high curiosity and good problem-solving skills. I am
                  passionate about learning new technologies and keeping up with
            ...
            <div className="xl:w-[1300px] m-auto border-orange-200 border-2 rounded-xl border-dashed h-fit max-[765px]:hidden md:w-[2000px]">
              <Image
                ...
                height={1600}
                alt="profile"
                className="object-fill rounded-xl mt-5 ml-5 grayscale hover:grayscale-0"
              />
            </div>
          </div>
        </div>
        ...
        <div
          id="Certificate-me"
          className="xl:mx-60 my-20 max-[765px]:mx-10 md:mx-28"
          data-aos="fade-up"
        >
          <p className="text-slate-300 text-3xl font-bold my-10 max-[765px]:text-2xl">
            <span className="text-2xl p-color-style max-[765px]:text-xl">
          ...
          <div className="flex max-[765px]:block">
            ...
            <div className="flex m-auto max-[765px]:block pt-10 md:block md:ml-4">
              <Image
                ...
                className=""
              />
              <p className="inline-block3 text-slate-400 text-lg mb-10 inline-block1 mx-5 max-[765px]:text-base mx-0">
                {tahun}
              </p>
            </div>
          </div>
        ...
        <div
          id="Work-me"
          className="mx-20 mt-40 mb-40 max-[765px]:mx-5"
          data-aos="fade-up"
        >
            ...
            <div className="work-me-1 xl:my-20 max-[765px]:my-5 md:my-5">
              <div className="flex max-[765px]:relative max-[765px]:grid">
                <div className="m-auto mr-10 color-bg-or2 max-[765px]:mr-0 max-[765px]:z-20 max-[765px]:opacity-95 max-[765px]:rounded-xl">
                  <p className="text-slate-300 text-2xl font-bold max-[765px]:px-5 max-[765px]:pt-5">
                    Website temperature data and Moisture from arduino
                  </p>
                  <div className="color-bg-or4  mt-5 rounded">
                    <p className="text-slate-500 text-lg w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                      A website that displays temperature and humidity data from
                      Arduino which was built using Next JS, with this website
                      you can see displays temperature and humidity data and
                      also displays the location of the Arduino
                    </p>
                  </div>
                  <p className="text-slate-500 text-sm pt-5 pb-2 pl-1 max-[765px]:pl-5 max-[765px]:text-xs">
                    Next, Tailwind, API, Vercel
                  </p>
                  <div className="pl-1 text max-[765px]:pl-4 max-[765px]:pb-5">
                    <Link
                      className="text-2xl"
                      href="https://github.com/ZeroNoSho/peta"
                    >
                      <FontAwesomeIcon
                        icon={faGithub}
                    ...
                    <Link
                      className="text-xl"
                      href="https://digimove.vercel.app/"
                    >
                      <FontAwesomeIcon
                ...
                <Image
                  ...
                  height={340}
                  alt="profile"
                  className="rounded-md m-auto xl:h-auto xl:w-5/12 max-[765px]:absolute max-[765px]:h-full max-[765px]:w-full md:w-80 md:h-36"
                />
              </div>
            </div>
            ...
            <div className="work-me-2 my-20 max-[765px]: my-5">
              <div className="flex max-[765px]:relative max-[765px]:grid">
                <Image
                  ...
                  height={340}
                  alt="profile"
                  className="rounded-md xl:w-5/12 xl:h-auto max-[765px]:absolute max-[765px]:h-full max-[765px]:w-full md:m-auto md:w-80 md:h-36"
                />
                <div className="m-auto ml-10 color-bg-or2 max-[765px]:ml-0 max-[765px]:z-20 max-[765px]:opacity-95 max-[765px]:rounded-xl">
                  ...
                  <div className="color-bg-or4 mt-5 rounded">
                    <p className="text-slate-500 text-lg w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                      An Online Store application built with ReactJS, With this
                      application, you can see various types of sales based on
                      existing categories. Plus, with a sleek and intuitive user
                      interface, you&apos;ll have all the information you need
                      at your fingertips.
                    </p>
                  </div>
                  <p className="text-slate-500 text-sm pt-5 pb-2 pl-1 max-[765px]:pl-5 max-[765px]:text-xs">
            ...
            <div className="work-me-3 my-20 max-[765px]: my-5">
              <div className="flex max-[765px]:relative max-[765px]:grid">
                <div className="m-auto mr-10 color-bg-or2 max-[765px]:mr-0 max-[765px]:z-20 max-[765px]:opacity-95 max-[765px]:rounded-xl">
                  ...
                  <div className="color-bg-or4  mt-5 rounded">
                    <p className="text-slate-500 text-lg w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                      A storage website built using Next JS, with On this
                      website you can store goods data, material data and also
                      With this website you can store transaction and plan data
                      production
                    </p>
                  </div>
                  <p className="text-slate-500 text-sm pt-5 pb-2 pl-1 max-[765px]:pl-5 max-[765px]:text-xs">
          ...
          <div className="work-other-content my-20 max-[765px]:my-5 ">
            <p className="p-color-style text-center font-semibold">
            ...
            <div className="flex flex-wrap importan">
              <div className="w-6/12 px-4 py-5 max-[765px]:w-full max-[765px]:px-0">
                <div className="color-bg-or3  mt-5 rounded">
                  ...
                  <p className="text-slate-500 text-lg pl-5 pr-5 w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                    3D flowers app built with ReactJS. With this application,
                    you can see beautiful flowers and you can add your partner.
                  </p>
                  <p className="p-5 text-slate-500 text-sm max-[765px]:text-xs">
                    React, ThreeJS, Vercel
                  </p>
                </div>
              </div>
              ...
              <div className="w-6/12 px-4 py-5 max-[765px]:w-full max-[765px]:px-0">
                <div className="color-bg-or3  mt-5 rounded">
                  ...
                  <p className="text-slate-500 text-lg pl-5 pr-5 w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                    Movie application built with Vanila Js. With this
                    application, you can search for movies by title, view movie
                    details.
                  </p>
                  <p className="p-5 text-slate-500 text-sm max-[765px]:text-xs">
                    Bootstrap, API
              ...
              <div className="w-6/12 px-4 py-5 max-[765px]:w-full max-[765px]:px-0">
                <div className="color-bg-or3  mt-5 rounded">
                  ...
                  <p className="text-slate-500 text-lg pl-5 pr-5 w-fit text-justify max-[765px]:py-1 max-[765px]:px-5 max-[765px]:text-sm">
                    The weather app is built with ReactJS. With this
                    application, you can get various kinds of weather data
                    around the world.
                  </p>
                  <p className="p-5 text-slate-500 text-sm max-[765px]:text-xs">
                    React, Bootstrap, API
      ...
      <div className="outside max-[765px]:hidden">
        <div
          className="fixed bottom-0 right-12 p-color-style flex inline-block1 items-center gap-2"
          data-aos="fade-up"
        >
          <Link
            className="p-color-style text-lg"
            href="mailto:rachmanari745@gmail.com"
          >
